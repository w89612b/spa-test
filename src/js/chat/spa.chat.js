...
spa.chat = (function() {
  ...
  var configMap = {
    ...
    <div class="spa-chat-head">\
      ...
      <div class="spa-chat-head-title"></div>\
    </div>\
  ...
  setSliderPosition = function(position_type, callback) {
    ...
    jqueryMap.$slider.animate({ height: height_px },
      animate_time,
      function() {
  ...
  // 示例：spa.chat.configModule({slider_open_em:18});
  // 目的：调整允许键的配置可设置键和值的映射
  // 参数：
  //  * set_chat_anchor - 一个回调来修改uri anchor来指示打开或关闭的状态。 如果不能满足请求的状态，则此回调必须返回false
  //  * chat_model - 聊天模型对象提供了与我们的即时消息交互的方法
  //  * people_model - 人们模型对象提供了管理模型列表的方法，模型保持slider_*设置，这些都是可选的标量。 有关完整列表示例，请参阅mapconfig.settable_map：slider_open_em是em中的开放高度
  // 设置：
